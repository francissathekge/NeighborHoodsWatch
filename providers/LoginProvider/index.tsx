...
import { loginUserRequestAction, createUserRequestAction, logOutUserRequestAction, setCurrentUserRequestAction, getUserDetailsRequestAction, getUserIdDetailsRequestAction } from './actions';
...
const UserProvider: FC<PropsWithChildren<{}>> = ({ children }) => {
  ...
  return (
    <UserContext.Provider value={state}>
      <UserActionContext.Provider value={{ loginUser, createUser, logOutUser, getUserDetails }}>
        {children}
